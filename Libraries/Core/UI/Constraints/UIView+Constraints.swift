...
public func equal<Anchor, Axis>(_ view: UIView, _ to: KeyPath<UIView, Anchor>, priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { layoutView in
        let constraint = layoutView[keyPath: to].constraint(equalTo: view[keyPath: to])
...
///   - constant: value
/// - Returns: created constraint
public func equal<LayoutDimension>(_ keyPath: KeyPath<UIView, LayoutDimension>, to constant: CGFloat, priority: UILayoutPriority = .required) -> Constraint where LayoutDimension: NSLayoutDimension {
    return { layoutView in
...
///   - constant: value
/// - Returns: created constraint
public func equal<LayoutDimension>(_ keyPath: KeyPath<UIView, LayoutDimension>, greaterOrEqual constant: CGFloat, priority: UILayoutPriority = .required) -> Constraint where LayoutDimension: NSLayoutDimension {
    return { layoutView in
        let constraint = layoutView[keyPath: keyPath].constraint(greaterThanOrEqualToConstant: constant)
        constraint.priority = priority
        return constraint
    }
}
...
///   - constant: value
/// - Returns: created constraint
public func equal<LayoutDimension>(_ keyPath: KeyPath<UIView, LayoutDimension>, lessOrEqual constant: CGFloat, priority: UILayoutPriority = .required) -> Constraint where LayoutDimension: NSLayoutDimension {
    return { layoutView in
        let constraint = layoutView[keyPath: keyPath].constraint(lessThanOrEqualToConstant: constant)
        constraint.priority = priority
        return constraint
    }
}
...
/// - Returns: created constraint
public func equal<LayoutDimension>(_ view: UIView, _ keyPath: KeyPath<UIView, LayoutDimension>, _ to: KeyPath<UIView, LayoutDimension>, ratio value: CGFloat, priority: UILayoutPriority = .required) -> Constraint where LayoutDimension: NSLayoutDimension {
    return { layoutView in
        let constraint = layoutView[keyPath: keyPath].constraint(equalTo: view[keyPath: to], multiplier: value)
        constraint.priority = priority
        return constraint
    }
}
...
///   - constant: value
/// - Returns: created constraint
public func equal<Anchor, Axis>(_ view: UIView, _ from: KeyPath<UIView, Anchor>, _ to: KeyPath<UIView, Anchor>, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { layoutView in
...
///   - lessOrEqual: value
/// - Returns: created constraint
public func equal<Anchor, Axis>(_ view: UIView, _ from: KeyPath<UIView, Anchor>, _ to: KeyPath<UIView, Anchor>, lessOrEqual: CGFloat = 0, priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { layoutView in
...
/// - Returns: created constraint
public func equal<Anchor, Axis>(_ view: UIView, _ from: KeyPath<UIView, Anchor>, _ to: KeyPath<UIView, Anchor>, greaterOrEqual: CGFloat = 0, priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { layoutView in
...
///   - constant: value
/// - Returns: created constraint
public func equal<Axis, Anchor>(_ view: UIView, _ keyPath: KeyPath<UIView, Anchor>, constant: CGFloat = 0, priority: UILayoutPriority = .required) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return equal(view, keyPath, keyPath, constant: constant, priority: priority)
}
...
public func equalToSuperview(with insets: UIEdgeInsets = .zero, pinBottomToSafeArea: Bool = true, pinTopToSafeArea: Bool = true) -> [Constraint] {
