...
enum StaticCityData {
    ...
    static var cities = [
        ...
        City(id: 2, city: "Moscow", description: "Moscow, on the Moskva River in western Russia, is the nation’s " +
        ...
        City(id: 3, city: "New York", description: "New York City comprises 5 boroughs sitting where the Hudson " +
            ...
            " Times Square."),
        City(id: 4, city: "Los Angeles", description: "Los Angeles is a sprawling Southern California city and the " +
        ...
        City(id: 5, city: "Limerick", description: "Limerick is a major city in the Republic of Ireland, set in " +
            ...
            " sites."),
        City(id: 6, city: "Cork", description: "Cork, just inland from Ireland’s southwest coast, is a university" +
        ...
        City(id: 7, city: "Galway", description: "Galway, a harbour city on Ireland’s west coast, sits where the " +
        ...
        City(id: 8, city: "San Francisco", description: "San Francisco, in northern California, is a hilly city on " +
        ...
        City(id: 9, city: "Washington, DC", description: "Washington, DC, the U.S. capital, is a compact city on " +
        ...
        City(id: 10, city: "Samarkand", description: "Samarkand is a city in Uzbekistan known for its mosques and" +
        ...
        City(id: 11, city: "Bukhara", description: "Bukhara is an ancient city in the central Asian country of " +
        ...
        City(id: 12, city: "Khiva", description: "Khiva is a city of approximately 50,000 people located in Xorazm " +
        ...
        City(id: 13, city: "St. Petersburg", description: "St. Petersburg is a Russian port city on the Baltic Sea. " +
        ...
        City(id: 14, city: "Paris", description: "Paris, France's capital, is a major European city and a global " +
        ...
        City(id: 15, city: "London", description: "London, the capital of England and the United Kingdom, is a " +
        ...
        City(id: 16, city: "Amsterdam", description: "Amsterdam is the Netherlands’ capital, known for its artistic" +
        ...
        City(id: 17, city: "Berlin", description: "Berlin, Germany’s capital, dates to the 13th century. Reminders" +
        ...
        City(id: 18, city: "Minsk", description: "Minsk, capital of Belarus, is a modern city dominated by " +
